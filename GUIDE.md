...
4. Open **<http://localhost:38726>** in your browser.
...
- **Your phone.** Install Tailscale on both machines, run
  `sudo tailscale serve --bg 38726`, open the `https://…ts.net` address on the
...
1. `npm install`, `npm run dev`, open `localhost:38726`.
