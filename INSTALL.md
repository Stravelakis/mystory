...
```
My Story running on http://0.0.0.0:38726
Vault: /home/you/mystory/vault
Models: cloud-first — none configured
```

Now open **<http://localhost:38726>** in your browser.
...
2. On the computer: `sudo tailscale serve --bg 38726`
...
| `Port 38726 is already in use` | Another copy of this app, or another project's dev server. `PORT=4748 npm run dev`. |
| Page loads but **RECORD** does nothing | The browser is refusing the microphone. Use `http://localhost:38726` on the machine itself, or the Tailscale `https` address from your phone. Not an embedded preview pane. |
